...
public class SimpleCanalConnector implements CanalConnector {
    ...
    public SimpleCanalConnector(SocketAddress address, String username, String password, String destination,
        ...
        // add by zhangyq: generate client id use random value(1000 - 1100)
        this.clientIdentity = new ClientIdentity(destination, (short) (1000 + new Random().nextInt(100)));

        // comment by zhangyq：do not use special client id: 1001
