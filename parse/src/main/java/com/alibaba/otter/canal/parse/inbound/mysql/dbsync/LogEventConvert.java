 ...
 * @version 1.0.0
 */
public class LogEventConvert extends AbstractCanalLifeCycle implements BinlogParser<LogEvent> {     // stinson: binlog 解析器
    ...
    public Entry parse(LogEvent logEvent) throws CanalParseException {
        ...
        // stinson: 区分 binlog 中的事件类型：show binary events;
