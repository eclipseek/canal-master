...
public class SessionHandler extends SimpleChannelHandler {
    ...
    // stinson: 接受客户端订阅请求、get 请求，取消订阅请求，ack ，rollback
    public void messageReceived(ChannelHandlerContext ctx, MessageEvent e) throws Exception {
        // stinson: too many logs, comment.
        ...
        try {
            switch (packet.getType()) {
                ...
                case GET:
                    ...
                    break;
                case CLIENTACK:     // 客户端获取到 get 消息之后发送 ack 消息。
                    ...
                    break;
                case CLIENTROLLBACK:        // stinson: 回滚会将服务端记录的读取位置修改成上次读取之前的。
